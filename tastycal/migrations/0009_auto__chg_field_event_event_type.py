...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tastycal_event', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tastycal.EventType'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.event_type'
        db.alter_column(u'tastycal_event', 'event_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tastycal.EventType']))
