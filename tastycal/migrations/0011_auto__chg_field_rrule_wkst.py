...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RRule.wkst'
        db.alter_column(u'tastycal_rrule', 'wkst', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'RRule.wkst'
        db.alter_column(u'tastycal_rrule', 'wkst', self.gf('tastycal.fields.RRuleWeekdayField')())
