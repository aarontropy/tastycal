...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'tastycal_event', 'start_time')

        # Deleting field 'Event.end_time'
        db.delete_column(u'tastycal_event', 'end_time')


        # Changing field 'Event.start'
        db.alter_column(u'tastycal_event', 'start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 9, 21, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'tastycal_event', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(),
                      keep_default=False)

        # Adding field 'Event.end_time'
        db.add_column(u'tastycal_event', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Event.start'
        db.alter_column(u'tastycal_event', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True))
