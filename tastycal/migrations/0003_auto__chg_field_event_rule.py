...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tastycal_event', 'rule_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tastycal.RRule']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.rule'
        db.alter_column(u'tastycal_event', 'rule_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tastycal.RRule']))
